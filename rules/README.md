...
> ⚠️ NOTE: This file is intended to be auto-updated by `scripts/update_rules.js`. If you edit rules manually, first update `data/rules.json` and then regenerate this file.
